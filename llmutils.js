...
async function runPrompt(prompt) {
  const res = await runCommand(
    `llama.cpp/build/bin/main -m models/7bq/ggml-model-q4_0-ggjt.bin -p "${prompt}" -n 64 -b 64 -c 2048 --top_k 1000 --top_p 0.75 --temp 0.75 --repeat_penalty 1.2 --repeat_last_n 128`
  );
  return res;
}
